...
for filename in files:
    ...
    output_path = "kaons_muons/kaons_muons_{}.root".format(filenum)
    filenum += 1
    ...
    print("Number of events without a trajectory: {}".format(len(NoTrajectories)))
    ...
    for event in range(len(tree['EcalRecHits_v3_v12/EcalRecHits_v3_v12.xpos_'])):
        ...
        for hit in range(len(tree['EcalRecHits_v3_v12/EcalRecHits_v3_v12.xpos_'][event])):
            ...
            if (pdgid == 321 or pdgid == -321 or pdgid == 13 or pdgid == -13):
